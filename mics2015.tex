...
Currently we have a framework for taking Clojure error messages, and making them more accessible for an introductory student. On top of that, we have plans for more improvements on that process and other potential solutions to that problem. We have determined an approach to integrating that framework into the current Clojure project management system.

Future work would involve polishing the error messaging framework, developing the error handling system, and performing usability studies to test that framework and system.
