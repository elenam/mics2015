...
Ideally we would like our system to be IDE independent. But we need to be mindful of the usability of the IDE. \mmcomment{This should probably find its way in somewhere, but I'm not sure where.} \emcomment{We would like to make our approach IDE-independent so that we can support usable IDEs that are available at any given point.}
