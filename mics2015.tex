...
Also, Clojure’s error messages are typically complex because they originate from the underlying Java interpreter, which many novice programmers will be unfamiliar with.
...
In this next example, the programmer is attempting to return a new hashmap with an added key-value pair.
...
In order to better understand what users of our software might encounter, we develop user scenarios detailing typical coding problems a new programmer might face. 
