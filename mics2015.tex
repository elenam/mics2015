...
\hfcomment{Add a section on laziness: I'll add my section from my last MICS paper as an example:}
...
Both IDEs have a lot of functionality that we are looking for, but they do have some notable differences. LightTable %still
requires a separate installation of Leiningen. %in order to run projects. 
