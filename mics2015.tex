...
Another way to replace Clojure error messages is to capture the thrown errors \emcomment{via a {\tt try/catch} statement} and rethrow \emcomment{substitute them with?} our replacement messages.
